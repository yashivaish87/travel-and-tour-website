...
const TourDetails = () => {
  ...
  //this is an example of how you can get the tour data from the tourData array
  //and will call API and get the data from the database
  const tour = tourData.find(tour => tour.id === id)

  //destructure from the tour object
  ...
  const submitHandler = (e) => { 
    ...
    //later you can call the API and submit the review to the server
